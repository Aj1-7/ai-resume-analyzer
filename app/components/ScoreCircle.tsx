    ...
    return (
        <div className="relative w-[100px] h-[100px] group">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="font-bold text-lg text-slate-100 group-hover:scale-110 transition-transform duration-300">
                    {score}
                </span>
                <span className="text-xs text-slate-300 font-medium">/100</span>
            </div>
            
            {/* Glow effect on hover */}
            <div className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                 style={{
                     background: `radial-gradient(circle, ${colors.from}20 0%, transparent 70%)`,
                     filter: 'blur(8px)'
                 }}>
            </div>
        </div>
